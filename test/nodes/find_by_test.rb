...
class FindByTest < ActiveSupport::TestCase
  ...
  test "find_by handles special characters safely" do
    ...
    special_company = CompanyNode.create(name: "Hack'); DROP TABLE users;--", founding_year: 2020)
  ...
  test "find_by properly escapes injection attempts" do
    ...
    injection_attempts.each do |evil_name|
      person = PersonNode.create(name: evil_name, age: 666)
  ...
  test "find_by generates parameterized queries through Cyrel" do
    ...
    person = PersonNode.create(name: injection_name, age: 99)
